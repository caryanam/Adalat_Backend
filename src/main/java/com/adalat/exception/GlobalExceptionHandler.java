...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handlePaymentPending(
            PaymentPendingException ex) {

        return build(HttpStatus.PAYMENT_REQUIRED, ex.getMessage());
    }


    // Lawyer application not yet approved
    @ExceptionHandler(LawyerNotApprovedException.class)
    public ResponseEntity<ApiResponseDTO<Object>> handleLawyerNotApproved(
            LawyerNotApprovedException ex) {
    ...
    //Duplicate Resource
    @ExceptionHandler({DuplicateResourceException.class, UserAlreadyExists.class, ResourceConflictException.class})
    ...
    public ResponseEntity<ApiResponseDTO<Object>> handleMaxUploadSizeExceeded(
        ...
        return build(
                HttpStatus.BAD_REQUEST,
                "File size exceeds the maximum allowed limit of 10MB. Please upload a smaller file."
        );
    }
